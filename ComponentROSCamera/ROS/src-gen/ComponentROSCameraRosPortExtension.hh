...
#include "ComponentROSCameraRosPortCallbacks.hh"
...
class ComponentROSCameraRosPortExtension : public ComponentROSCameraExtension, public ComponentROSCameraRosPortBaseClass
{
private:
	ros::NodeHandle *nh;
	
	ComponentROSCameraRosPortCallbacks *callbacksPtr;
	
	virtual int extensionExecution() override;
public:
	ComponentROSCameraRosPortExtension();
	virtual ~ComponentROSCameraRosPortExtension();
	...
	inline ros::Subscriber* get_camPtr() {
		return &_cam;
	}
