...
class ComponentROSCameraRosPortCallbacksInterface {
public:
	ComponentROSCameraRosPortCallbacksInterface() { };
	virtual ~ComponentROSCameraRosPortCallbacksInterface() { }
	
	virtual void _cam_cb (const sensor_msgs::Image::ConstPtr &msg) = 0;
