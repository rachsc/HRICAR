...
#include "ComponentROSCameraRosPortCallbacksInterface.hh"

class ComponentROSCameraRosPortCallbacks : public ComponentROSCameraRosPortCallbacksInterface {
public:
	ComponentROSCameraRosPortCallbacks();
	virtual ~ComponentROSCameraRosPortCallbacks();
	
	virtual void _cam_cb (const sensor_msgs::Image::ConstPtr &msg) override;
