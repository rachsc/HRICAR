...
ComponentROSCameraRosPortCallbacks::ComponentROSCameraRosPortCallbacks() {  }

ComponentROSCameraRosPortCallbacks::~ComponentROSCameraRosPortCallbacks() {  }

void ComponentROSCameraRosPortCallbacks::_cam_cb (const sensor_msgs::Image::ConstPtr &msg)
{
	// for implementing this method, you can use the "COMP->" macro to access the component's class members
	COMP->cameraActivity->_cam_cb(msg);
