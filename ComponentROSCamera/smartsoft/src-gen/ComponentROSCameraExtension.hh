...
#ifndef COMPONENTROSCAMERA_EXTENSION_HH_
#define COMPONENTROSCAMERA_EXTENSION_HH_
...
public:
	ComponentROSCameraExtension(const std::string &name);
	virtual ~ComponentROSCameraExtension();
...
#endif /* COMPONENTROSCAMERA_EXTENSION_HH_ */
