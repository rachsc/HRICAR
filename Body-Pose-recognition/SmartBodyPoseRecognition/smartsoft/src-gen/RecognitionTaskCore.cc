...
Smart::StatusCode RecognitionTaskCore::bodyPoseEventServiceOutPut(CommObjectRecognitionObjects::CommObjectRecognitionEventState &eventState)
{
	Smart::StatusCode result = COMP->bodyPoseEventServiceOut->put(eventState);
	if(useLogging == true) {
		//FIXME: use logging
