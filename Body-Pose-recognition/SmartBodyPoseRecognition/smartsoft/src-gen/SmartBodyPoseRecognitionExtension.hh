...
#ifndef SMARTBODYPOSERECOGNITION_EXTENSION_HH_
#define SMARTBODYPOSERECOGNITION_EXTENSION_HH_
...
public:
	SmartBodyPoseRecognitionExtension(const std::string &name);
	virtual ~SmartBodyPoseRecognitionExtension();
...
#endif /* SMARTBODYPOSERECOGNITION_EXTENSION_HH_ */
