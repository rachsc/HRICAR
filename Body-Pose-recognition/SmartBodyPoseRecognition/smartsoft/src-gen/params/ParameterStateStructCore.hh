...
public:
		...
		protected:
			 ...
			 */
			std::string bodypose_db_path;
			std::string moped_model_path;
		
		public:
			// default constructor
			DataType() {
				bodypose_db_path = "data/BodyPoseRecognition/xsdDb.xml";
				moped_model_path = "data/BodyPoseRecognition/MopedModels";
			}
		
			/**
			 * here are the public getters
			 */
			inline std::string getBodypose_db_path() const { return bodypose_db_path; }
			inline std::string getMoped_model_path() const { return moped_model_path; }
			
			void to_ostream(std::ostream &os = std::cout) const
			{
				os << "Data(";
				os << "bodypose_db_path = " << bodypose_db_path << ", ";
