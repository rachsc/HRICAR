...
pre-start)
	echo "Triggering pre-start hooks FROM COMPONENT SmartBodyPoseRecognition ..."
	# Insert commands you want to call prior to starting the components
;;

post-start)
	echo "Triggering post-start hooks FROM COMPONENT SmartBodyPoseRecognition ..."
	# Insert commands you want to call after all components were started
;;

pre-stop)
	echo "Triggering pre-stop hooks FROM COMPONENT SmartBodyPoseRecognition ..."
	# Insert commands you want to call before stopping all components
;;

post-stop)
	echo "Triggering post-stop hooks FROM COMPONENT SmartBodyPoseRecognition ..."
