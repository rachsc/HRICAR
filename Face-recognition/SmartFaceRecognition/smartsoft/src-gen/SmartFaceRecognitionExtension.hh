...
#ifndef SMARTFACERECOGNITION_EXTENSION_HH_
#define SMARTFACERECOGNITION_EXTENSION_HH_
...
public:
	SmartFaceRecognitionExtension(const std::string &name);
	virtual ~SmartFaceRecognitionExtension();
...
#endif /* SMARTFACERECOGNITION_EXTENSION_HH_ */
