...
Smart::StatusCode RecognitionTaskCore::faceEventServiceOutPut(CommObjectRecognitionObjects::CommObjectRecognitionEventState &eventState)
{
	Smart::StatusCode result = COMP->faceEventServiceOut->put(eventState);
	if(useLogging == true) {
		//FIXME: use logging
