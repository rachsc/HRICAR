...
#ifndef SMARTEMOTIONRECOGNITION_EXTENSION_HH_
#define SMARTEMOTIONRECOGNITION_EXTENSION_HH_
...
public:
	SmartEmotionRecognitionExtension(const std::string &name);
	virtual ~SmartEmotionRecognitionExtension();
...
#endif /* SMARTEMOTIONRECOGNITION_EXTENSION_HH_ */
