...
public:
		...
		protected:
			 ...
			 */
			std::string emotion_db_path;
			std::string moped_model_path;
		
		public:
			// default constructor
			DataType() {
				emotion_db_path = "data/EmotionRecognition/xsdDb.xml";
				moped_model_path = "data/EmotionRecognition/MopedModels";
			}
		
			/**
			 * here are the public getters
			 */
			inline std::string getEmotion_db_path() const { return emotion_db_path; }
			inline std::string getMoped_model_path() const { return moped_model_path; }
			
			void to_ostream(std::ostream &os = std::cout) const
			{
				os << "Data(";
				os << "emotion_db_path = " << emotion_db_path << ", ";
